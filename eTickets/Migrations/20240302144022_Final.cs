        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(type: "longtext", nullable: false),
                    SnackPhoto = table.Column<string>(type: "longtext", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberTaken = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SnackShoppingCartItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SnackShoppingCartItems_Snacks_SnackId",
                        column: x => x.SnackId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SnackShoppingCartItems_SnackId",
                table: "SnackShoppingCartItems",
                column: "SnackId");
        }
